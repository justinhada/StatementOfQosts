...
public class Testdaten
{
	...
	protected static final Buchung BUCHUNG_1 = Buchung.aus(Typ.AUSGABE, UMSATZ_1, KATEGORIE_1).get();
	protected static final Buchung BUCHUNG_2 = Buchung.aus(Typ.EINNAHME, UMSATZ_2, KATEGORIE_2).get();
	// -----------------------------------------------------------------------------------------------------------------
}
